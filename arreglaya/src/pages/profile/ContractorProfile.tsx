...
export default function ContractorProfile(){
  ...
  const [description, setDescription] = React.useState('') // no se envía aún si el API no lo soporta
  ...
  async function save(){
    ...
    try {
      ...
      // if (profession!== (base?.profession?? '')) patch.profession = profession
      // description: omitir si tu API aún no lo soporta
          ...
          <Stack spacing={2}>
            ...
            {/* <Stack direction={{ xs:'column', sm:'row' }} spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select labelId="prof" label="Profesión" value={profession} onChange={(e)=>setProfession(e.target.value)}>
